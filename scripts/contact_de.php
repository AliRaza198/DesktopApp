...
<ul>
			<li><a href="../de/index_de.htm">Home</a></li>
			<li><a href="../de/diskografie_de.htm">Projekte</a></li>
			<li><a href="../de/biografie_de.htm">Biografie</a></li>
			<li><a href="../de/kontakt_de.htm"><strong>Kontakt</strong></a></li>
	  </ul>
  ...
  <div class="div" id="content">
  	  	<p class="headlinenolist">Kontakt </p>
	    <p>
	<p align="center">&nbsp;</p>
	<p align="center">&nbsp;</p>
	<p align="center">&nbsp;</p>
...
echo "Fehler: &Uuml;bermittlung fehlgeschlagen (unbekannter Fehler). Bitte schicken Sie Ihre Nachricht an info@root-studio.com";
} 
